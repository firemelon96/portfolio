  ...
  return (
    ...
    >
      <a href={url} target='_blank'>
        <div className='px-5 py-4 z-50 sm:pl-10 sm:pr-2 flex flex-col h-full sm:group-even:ml-36 gap-2 sm:pt-10 max-w-[70%] sm:group-even:w-full'>
          <h3 className='text-2xl font-semibold line-clamp-2'>{title}</h3>
          <p className='mt-2 line-clamp-4  text-gray-700 dark:text-white'>
            {description}
          </p>
        </div>
      </a>
      ...
      <Image
        ...
        alt={title}
        quality={95}
        className='sm:absolute object-cover h-64 z-10 sm:block sm:top-12 sm:-right-48 px-3 pb-3 sm:w-3/4 shadow-2xl rounded-t-md group-even:right-[initial] group-even:-left-48 group-hover:-translate-x-3 group-hover:translate-y-3 group-hover:-rotate-2 group-hover:scale-110 transition group-even:group-hover:rotate-2 group-even:group-hover:translate-x-3 group-even:group-hover:translate-y-3'
      />

      <div className='w-full px-10 z-50'>
